...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.twoButton.grid(row=3, column=1, sticky="NWNWSWSE")
        ...
        self.equalButton = Button(self, font=("Helvtica", 11), text="=", borderwidth=0,
                                  command=lambda: self.calculateExpression())
        self.equalButton.grid(row=3, column=4, rowspan=2, sticky="NWNESWSE")

        self.zeroButton = Button(self, font=("Helvetica", 11), text="0", borderwidth=0,
                                 command=lambda: self.appendToDisplay("0"))
        self.zeroButton.grid(row=4, column=0, columnspan=2, sticky="NWNWSWSE")
